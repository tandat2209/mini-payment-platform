...
import { addRecipientRail, createRecipient } from '@/features/customer/api';
import {
  useRecipientCapabilitiesQuery,
  useRecipientRequirementsQuery,
  useRecipientsQuery,
} from '@/features/customer/api/use-customer-queries';
import { CustomerRecipientsPage } from '@/features/customer/components/customer-recipients-page';
