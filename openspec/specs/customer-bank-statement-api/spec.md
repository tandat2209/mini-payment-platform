# customer-bank-statement-api Specification

## Purpose

Define the customer-facing statement API for listing available statement periods and retrieving statement detail for the current customer's active wallet.
