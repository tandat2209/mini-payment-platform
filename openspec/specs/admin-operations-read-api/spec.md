# admin-operations-read-api Specification

## Purpose

Define the admin-scoped read APIs that power the operations console with live wallet, treasury, payout, webhook, and reconciliation data.
