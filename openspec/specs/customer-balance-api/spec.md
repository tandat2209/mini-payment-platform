# customer-balance-api Specification

## Purpose

Define the customer-facing balance read API for retrieving the active wallet balance summary for the current customer.
